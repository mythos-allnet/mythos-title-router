...
this.state.reorder[conf]=true;return true;},save(){const v=this.state.values;const n=this.state.creates;const c=this.state.changes;const d=this.state.deletes;const r=this.state.reorder;const self=this;const snew=[];let pkgs={};const tasks=[];if(d)
